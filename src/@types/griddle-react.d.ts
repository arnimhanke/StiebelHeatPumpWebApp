...
/**
 * Typ-Datei für die Griddle-Tabelle.
 * Dokumentation: https://griddlegriddle.github.io/Griddle/docs/
 */
declare module 'griddle-react' {
    ...
    export class Griddle<T> extends React.Component<GriddleProps<T>, any> {
    }
...
declare module 'griddle-react/dist/module/utils' {
    var Functions: {
        columnUtils: Function,
        compositionUtils: Function,
        dataUtils: Function,
        rowUtils: Function,
        sortUtils: Function,
        connect: (props: any, context: any) => any,
    };
...
declare module 'griddle-react/dist/module/selectors/dataSelectors' {
    export const dataSelector: (state: any) => any;
    export const visibleColumnPropertiesSelector: (state: any) => any;
    export const hiddenColumnPropertiesSelector: (state: any) => any;
    export const pageSizeSelector: (state: any) => any;
}

declare module 'griddle-react/dist/module/actions/index.js' {

    export const getNext: () => any;
    export const getPrevious: () => any;
    export const setPage: (pageNumber: any) => any;
    export const setFilter: (filter: any) => any;
    export const setSortColumn: (sortProperties: any) => any;
    export const toggleSettings: () => any;
    export const toggleColumn: (columnId: any) => any;
    export const setPageSize: (pageSize: any) => any;
    export const updateState: (_ref: any) => any;
}